define(["require", "exports", "./dom", "./util"], function (require, exports, dom_1, util_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getVersion = exports.validateLicense = exports.registerLicense = void 0;
    ...
    var LicenseValidator = /** @class */ (function () {
        ...
        LicenseValidator.prototype.validate = function () {
            if (!this.isValidated && (util_1.containerObject && !(0, util_1.getValue)(convertToChar(bypassKey), util_1.containerObject) && !(0, util_1.getValue)('Blazor', util_1.containerObject))) {
                ...
                if (validateMsg && typeof document !== "undefined" && !(0, util_1.isNullOrUndefined)(document)) {
                    var errorDiv = (0, dom_1.createElement)('div', {
                ...
                (0, util_1.setValue)(convertToChar(bypassKey), this.isValidated, util_1.containerObject);
            }
        };
...
//# sourceMappingURL=validate-lic.js.map