...
define(["require", "exports", "./dom", "./base", "./browser", "./event-handler", "./notify-property-change"], function (require, exports, dom_1, base_1, browser_1, event_handler_1, notify_property_change_1) {
    ...
    exports.enableRipple = exports.isRippleEnabled = exports.rippleEffect = exports.Animation = void 0;
    /**
    ...
    var Animation = /** @class */ (function (_super) {
        ...
        Animation.prototype.animate = function (element, options) {
            ...
            if (typeof element === 'string') {
                var elements = Array.prototype.slice.call((0, dom_1.selectAll)(element, document));
        ...
        var Animation_1;
        __decorate([
            (0, notify_property_change_1.Property)('FadeIn')
        ], Animation.prototype, "name", void 0);
        __decorate([
            (0, notify_property_change_1.Property)(400)
        ], Animation.prototype, "duration", void 0);
        __decorate([
            (0, notify_property_change_1.Property)('ease')
    ...
    function rippleHandler(e) {
        ...
        var element = selector ? (0, dom_1.closest)(target, selector) : target;
        if (!element || (this.rippleOptions && (0, dom_1.closest)(target, this.rippleOptions.ignore))) {
            return;
        }
        ...
        var rippleElement = (0, dom_1.createElement)('div', { className: 'e-ripple-element', styles: styles });
    ...
    function removeRipple(e, eventArgs) {
        ...
        var rippleElements = (0, dom_1.selectAll)('.e-ripple-element', element);
